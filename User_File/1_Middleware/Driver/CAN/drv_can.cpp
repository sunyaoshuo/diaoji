...
void can_filter_mask_config(FDCAN_HandleTypeDef *hfdcan)
{
    ...
    // 全局滤波器：标准帧仍由上方全通滤波器接收；未匹配扩展数据帧进入 FIFO0，
    // 供 RobStride 私有 29 位扩展帧协议使用。遥控帧仍然拒绝。
    HAL_FDCAN_ConfigGlobalFilter(hfdcan, FDCAN_REJECT, FDCAN_ACCEPT_IN_RX_FIFO0, FDCAN_FILTER_REMOTE, FDCAN_FILTER_REMOTE);
...
uint8_t CAN_Transmit_Data(FDCAN_HandleTypeDef *hfdcan, uint16_t ID, uint8_t *Data, uint16_t Length)
{
    ...
    switch (Length)
    {
    case 0: Data_Length = FDCAN_DLC_BYTES_0; break;
    case 1: Data_Length = FDCAN_DLC_BYTES_1; break;
    case 2: Data_Length = FDCAN_DLC_BYTES_2; break;
    case 3: Data_Length = FDCAN_DLC_BYTES_3; break;
    case 4: Data_Length = FDCAN_DLC_BYTES_4; break;
    case 5: Data_Length = FDCAN_DLC_BYTES_5; break;
    case 6: Data_Length = FDCAN_DLC_BYTES_6; break;
    case 7: Data_Length = FDCAN_DLC_BYTES_7; break;
    case 8: Data_Length = FDCAN_DLC_BYTES_8; break;
    default: return static_cast<uint8_t>(HAL_ERROR);
    }
